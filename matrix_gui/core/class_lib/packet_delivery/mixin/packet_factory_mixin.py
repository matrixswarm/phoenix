import importlib
import traceback
from matrix_gui.core.class_lib.packet_delivery.packet.error.packet_not_found import Packet as ErrorPacket
...
class PacketFactoryMixin:
    ...
    def get_delivery_packet(self, dotted_path: str, new=True):
        ...
        """
        try:
            full_path = f"matrix_gui.core.class_lib.packet_delivery.packet.{dotted_path}"
