...
import importlib
import traceback
from matrix_gui.core.class_lib.packet_delivery.utility.encryption.config import ENCRYPTION_CONFIG
from matrix_gui.core.class_lib.packet_delivery.utility.crypto_processors.packet_encryption_factory import packet_encryption_factory
from matrix_gui.core.class_lib.packet_delivery.utility.crypto_processors.football import Football
...
class PacketReceptionFactoryMixin:
    ...
    def get_reception_agent(self, path: str, football:Football, new=True):
        ...
        try:
            full_path = f"matrix_gui.core.class_lib.packet_delivery.reception_agent.{path}.reception_agent"
            ...
            if hasattr(self, "log") and callable(getattr(self, "log", None)):
                ...
                traceback.print_exc()
            try:
                from matrix_gui.core.class_lib.packet_delivery.reception_agent.error.reception_agent_not_found import ReceptionAgent as Fallback
