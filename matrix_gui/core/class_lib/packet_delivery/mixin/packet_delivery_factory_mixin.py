...
class PacketDeliveryFactoryMixin:
    ...
    def get_delivery_agent(self, path: str, football:Football, new=True):
        ...
        try:
            ...
            full_path = f"matrix_gui.core.class_lib.packet_delivery.delivery_agent.{path}.delivery_agent"
            ...
            try:
                from matrix_gui.core.class_lib.packet_delivery.delivery_agent.error.delivery_agent_not_found import DeliveryAgent as Fallback
