...
class HTTPSConnectionEditor(ConnectionEditorInterface):
    ...
    def serialize(self) -> dict:
        # Ensure serial exists (auto-generate for NEW)
        self._ensure_serial()
    ...
    def validate(self):
        ...
        # Validate protocol
        if not ProtocolUtils.validate_protocol(self.proto.text(), "https"):
